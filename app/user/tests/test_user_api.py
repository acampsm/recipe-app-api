...
class PublicUserApiTests(TestCase):
    ...
    def test_create_valid_user_success(self):
        """Test create user with vaild payload is succeful"""
        payload = {
            'email': 'test2@joe.com',
            'password': 'testpass',
            'name': 'test name'
    ...
    def test_user_exists(self):
        ...
        payload = {'email': 'test@joe.com', 'password': 'testpass'}
        create_user(**payload)
    ...
    def test_password_too_short(self):
        ...
        payload = {'email': 'test@joe.com', 'password': 'pw'}
        res = self.client.post(CREATE_USER_URL, payload)
    ...
    def test_retriieve_user_authorized(self):
        """Test that authenticatioin is required for users"""
...
class PrivateUserApitests(TestCase):
    ...
    def test_retriieve_profile_success(self):
    ...
    def test_post_me_not_allowed(self):
        """Test post is not alloved on the me url"""
